...
- Release build 零新警告（pre-existing Swift 6 严格并发告警未处理；本机无 Xcode，仅 CommandLineTools，SwiftUI 宏编不过，待有 Xcode 的机器上跑 make test）
...
- Python CLI 源码（解密/读取逻辑参考）：`/Users/lilei/wechatcli/repo/wechat_cli/core/`
