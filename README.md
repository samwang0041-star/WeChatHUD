...
<p align="center">
  <a href="https://github.com/samwang0041-star/WeChatHUD/releases/latest"><img src="https://img.shields.io/badge/下载-1.5.4-0B5960?style=for-the-badge" alt="下载 1.5.4"></a>
...
<p align="center">
  <a href="https://github.com/samwang0041-star/WeChatHUD/releases/latest/download/WeChatHUD-1.5.4-macOS14-arm64.zip"><strong>下载安装包</strong></a>
  ·
...
1. **下载** [`WeChatHUD-1.5.4-macOS14-arm64.zip`](https://github.com/samwang0041-star/WeChatHUD/releases/latest/download/WeChatHUD-1.5.4-macOS14-arm64.zip)，解压拖进「应用程序」——已签名并公证，双击即开。
...
<p align="center">
  <sub>当前正式版 <strong>1.5.4</strong> · 源码与安装包同仓 · 应用内可检查更新</sub><br>
