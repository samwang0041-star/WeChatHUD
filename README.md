...
<p align="center">
  <a href="https://github.com/samwang0041-star/WeChatHUD/releases/latest"><img src="https://img.shields.io/badge/下载-1.2.23-0B5960?style=for-the-badge" alt="下载 1.2.23"></a>
...
<p align="center">
  <a href="https://github.com/samwang0041-star/WeChatHUD/releases/latest/download/WeChatHUD-1.2.23-macOS14-arm64.zip"><strong>下载安装包</strong></a>
  ·
...
开了也先进「待确认」队列。群聊不自动发（@ 提醒也只出草稿）；转账、红包、验证码强制人工；每会话有发送上限。
...
1. **下载** [`WeChatHUD-1.2.23-macOS14-arm64.zip`](https://github.com/samwang0041-star/WeChatHUD/releases/latest/download/WeChatHUD-1.2.23-macOS14-arm64.zip)，解压拖进「应用程序」——已签名并公证，双击即开。
...
<p align="center">
  <sub>当前正式版 <strong>1.2.23</strong> · 源码与安装包同仓 · 应用内可检查更新</sub><br>
