...
final class MessageHelpersTests: XCTestCase {
    ...
    func testDisplayTextStripsWeChatMentionDecoration() {
        let raw = "@S琪婷婷❁\u{0489}\u{0489}\u{0489}\u{0489}\u{0489}\u{0489}\u{0489}\u{0489}\u{2005}\u{2005}@李雷\u{2005}"
        XCTAssertEqual(MessageHelpers.displayText(raw), "@S琪婷婷❁ @李雷")
    }
