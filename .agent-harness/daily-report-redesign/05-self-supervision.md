...
Checkpoint gate:
```bash
"/Users/lilei/.claude/skills/agent-harness/scripts/harness-gate.sh" --workspace "/Users/lilei/wechatcli/WeChatHUD/.agent-harness/daily-report-redesign" --mode long-job --stage checkpoint
```

Final gate:
```bash
"/Users/lilei/.claude/skills/agent-harness/scripts/harness-gate.sh" --workspace "/Users/lilei/wechatcli/WeChatHUD/.agent-harness/daily-report-redesign" --mode long-job --stage final
```
...
## Log/Prompt Paths
- Handoff workspace: `/Users/lilei/wechatcli/WeChatHUD/.agent-harness/daily-report-redesign/`
