...
```bash
HARNESS_SKILL_DIR=/Users/lilei/.codex/skills/agent-harness
HANDOFF_WORKSPACE=/Users/lilei/wechatcli/WeChatHUD/.agent-harness/daily-report-real-e2e-20260505
...
```bash
"/Users/lilei/.codex/skills/agent-harness/scripts/harness-monitor.sh" \
  --workspace "/Users/lilei/wechatcli/WeChatHUD/.agent-harness/daily-report-real-e2e-20260505" \
  --mode long-job \
  --stage final \
  --interval 30 \
  --idle-timeout 600 \
  --cwd "/Users/lilei/wechatcli/WeChatHUD" \
  --request-file "/Users/lilei/wechatcli/WeChatHUD/.agent-harness/daily-report-real-e2e-20260505/00-request.md" \
  > "/Users/lilei/wechatcli/WeChatHUD/.agent-harness/daily-report-real-e2e-20260505/monitor-supervisor.log" 2>&1 &
echo $! > "/Users/lilei/wechatcli/WeChatHUD/.agent-harness/daily-report-real-e2e-20260505/monitor.pid"
```
