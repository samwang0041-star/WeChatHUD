...
## 2026-09-14 — 1.4.0：代码回到 1.3.8

### [Engineer] 撤回 1.3.9 日常页精修，版本号越过已发布的 1.3.9

- 工作树与 `v1.3.8` 一致：1.3.9 新增的契约测试和 craft-loop 文档一并去掉。
- 版本号改为 1.4.0，应用内更新可以盖过 1.3.9。
- 自动回复默认关，护栏未改。

## 2026-09-14 — 1.3.9：日常页收成一套可走下去的界面

### [Engineer] 一屏一个下一步，空/错会说话，按下会让步（已撤回）

- 已随 1.4.0 回退。安装包仍在 GitHub `v1.3.9`。
