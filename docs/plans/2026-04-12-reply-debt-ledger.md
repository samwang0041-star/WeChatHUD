...
```bash
cd /Users/lilei/wechatcli/WeChatHUD && swift test --filter HUDStoreTests/testReplyDebtConfigRoundTrip
```
...
```bash
cd /Users/lilei/wechatcli/WeChatHUD
...
```bash
cd /Users/lilei/wechatcli/WeChatHUD && swift test --filter ReplyDebtScorerTests
```
...
```bash
cd /Users/lilei/wechatcli/WeChatHUD && swift build
```
...
```bash
cd /Users/lilei/wechatcli/WeChatHUD && swift test
```
...
```bash
cd /Users/lilei/wechatcli/WeChatHUD && swift test --filter ReplyDebtJudgeTests
```
...
```bash
cd /Users/lilei/wechatcli/WeChatHUD && make app && open .build/WeChatHUD.app
```
