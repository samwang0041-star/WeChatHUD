...
|---|---|---|---|---|
| installed app, PID 45968 | `/Applications/WeChatHUD.app/Contents/MacOS/WeChatHUD` | `com.wechat-cli.hud` | Developer ID Application: <REDACTED> (`<REDACTED_TEAMID>`), notarization ticket stapled | `468352fdcf7a9d9cf92d8c8c0b6399c34718473d` |
