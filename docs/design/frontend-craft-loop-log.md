...
| 5 | 待确认回复 | in-progress | 8.4 | 确认框「返回修改」会让步。已到 8.0，连续两刀 <0.3 |
| 6 | 自动回复设置 | in-progress | 8.2 | 发送键不再是系统蓝分段。已到 8.0。本刀：自动回复设置 |
