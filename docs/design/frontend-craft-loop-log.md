...
一刀一节，新的写在最上面。
AI 服务总分 8.1、已到过 8.0，连续两刀 <0.3 后换到微信连接。微信连接总分 8.2、已到过 8.0，连续两刀 <0.3 后换到首次引导。首次引导总分 8.3、已到过 8.0，连续两刀 <0.3 后换到关注谁。关注谁总分 8.1、已到过 8.0，连续两刀 <0.3 后换到待办。待办总分 8.0、已到过 8.0，连续两刀 <0.3 后换到今日小结。今日小结总分 8.1、已到过 8.0，连续两刀 <0.3 后换到提醒方式。提醒方式总分 8.0、已到过 8.0，连续两刀 <0.3 后换到使用偏好。使用偏好总分 8.3、已到过 8.0，连续两刀 <0.3 后换到本地资料。本地资料总分 8.0、已到过 8.0，连续两刀 <0.3 后换到怎么用。怎么用总分 8.3、已到过 8.0，连续两刀 <0.3 后换到岛·通知横幅。岛·通知横幅总分 8.5，标 done。岛·紧凑/peek 总分 8.5，标 done。待确认回复 8.5，标 done。自动回复设置 8.5，标 done。AI 服务 8.4、已到过 8.0，连续两刀 <0.3 后换到微信连接。微信连接 8.5，标 done。AI 服务 8.5，标 done。首次引导 8.5，标 done。关注谁 8.5，标 done。待办 8.4、已到过 8.0，连续两刀 <0.3 后换到今日小结。今日小结 8.5，标 done。待办 8.5，标 done。怎么用 8.5，标 done。队列 1–13 都 done。
...
| 3 | 岛·通知横幅 | done | 8.5 | 关闭留下「还在收件箱。」；稍后/关闭仍无字留给巡检 |
| 4 | 岛·紧凑/peek | done | 8.5 | 双翼悬停洗层。弹簧和 peek 宽度未改 |
| 5 | 待确认回复 | done | 8.5 | 待核对不再假装成功。确认发送仍是青玉 |
| 6 | 自动回复设置 | done | 8.5 | 清除历史留下「记录已清除。」每小时上限仍是系统菜单 |
| 7 | AI 服务 | done | 8.5 | 「能不能用」下面不再压长说明。确认能用仍是青玉 |
| 8 | 微信连接 | done | 8.5 | 准备失败说人话。去选对话仍是青玉 |
| 9 | 首次引导 | done | 8.5 | 名单行按下会让步。开始使用仍是青玉 |
| 10 | 关注谁 | done | 8.5 | 添加框读失败说人话。添加关注仍是青玉 |
| 11 | 待办 | done | 8.5 | 没记下说人话。标记完成仍是青玉 |
| 12 | 今日小结 | done | 8.5 | 跟进完成会说话。导出仍是青玉 |
| 13 | 提醒方式 / 使用偏好 / 本地资料 / 怎么用 | done | 8.5 | 「连接微信」悬停洗层。不是青玉 |
| 14 | 侧栏与页头 | queued | — | 勿第一刀就合并 18 个 tab |
| 15 | 对话详情 / 对话框 | queued | — | |
| 16 | 全站微交互巡检 | queued | — | 放在多数页面主动词成立之后 |

## Cycle 176 — 2026-09-14 — 怎么用

- Surface: 怎么用
- Files: `Sources/WeChatHUD/Views/CompanionGuideView.swift`、`Tests/WeChatHUDTests/CompanionGuideContractTests.swift`
- Before: 总分 8.3（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 8.0 / 状态戏 8.0 / 稀疏 8.5 / 回执 8.5）
- Debt picked: 「连接微信」按下会让步，悬停没有洗层。
- After: 总分 8.5（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 9.3 / 状态戏 8.0 / 稀疏 8.5 / 回执 8.5）
- Changed: 开怎么用，悬停「连接微信」会洗一层。按下仍会让步。不是青玉。护栏未改。
- Verified: `swift test --filter CompanionGuideContractTests` 11 个用例全绿；`swift build -c release`。走查：开怎么用 → 看到「先连接微信，再选人，再看今天。」→ 悬停「连接微信」洗层 → 按下缩放 → 「连接微信」不是青玉。
- Next: 怎么用总分 8.5，主动词/空气/短句 ≥ 8，标 done。队列 1–13 都 done。

## Cycle 175 — 2026-09-14 — 待办

- Surface: 待办
- Files: `Sources/WeChatHUD/Views/DiscussionWorkspaceView.swift`、`Tests/WeChatHUDTests/DiscussionWorkspaceContractTests.swift`
- Before: 总分 8.4（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 8.8 / 状态戏 8.0 / 稀疏 9.5 / 回执 8.2）
- Debt picked: 没记下仍是红叹号「保存失败，事项状态未更改」。
- After: 总分 8.5（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 8.8 / 状态戏 9.0 / 稀疏 9.5 / 回执 8.2）
- Changed: 「标记完成」没记下时看到「刚才没记下。」和「再试一次」，没有红叹号。青玉仍只在「标记完成」。护栏未改。
- Verified: `swift test --filter DiscussionWorkspaceContractTests` 8 个用例全绿；`swift build -c release`。走查：开待办 → 选一条 → 点「标记完成」失败时看到「刚才没记下。」和「再试一次」→ 没有红叹号 → 「标记完成」仍是青玉。
- Next: 待办总分 8.5，主动词/空气/短句 ≥ 8，标 done。换到怎么用。

## Cycle 174 — 2026-09-14 — 今日小结
...
- Before: 总分 8.3（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 8.2 / 状态戏 9.3 / 稀疏 8.5 / 回执 8.0）
- Debt picked: 跟进点「标记完成」后页上没留下刚才完成了哪条。
- After: 总分 8.5（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 8.2 / 状态戏 9.3 / 稀疏 8.5 / 回执 9.5）
- Changed: 点跟进「标记完成」后看到「「…」已完成。」青玉仍只在「导出」。护栏未改。
- Verified: `swift test --filter DailyReportWorkspaceContractTests` 9 个用例全绿；`swift build -c release`。走查：开今日小结 → 点跟进「标记完成」→ 看到「「…」已完成。」→ 「导出」仍是青玉。
- Next: 今日小结总分 8.5，主动词/空气/短句 ≥ 8，标 done。换到待办。

## Cycle 173 — 2026-09-14 — 今日小结

- Surface: 今日小结
- Files: `Sources/WeChatHUD/Views/DailyReportCommandCenterView.swift`、`Tests/WeChatHUDTests/DailyReportWorkspaceContractTests.swift`
- Before: 总分 8.1（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 8.2 / 状态戏 8.0 / 稀疏 8.5 / 回执 8.0）
- Debt picked: 来源未验证仍是橙色「今日来源未验证」加长说明。
- After: 总分 8.3（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 8.2 / 状态戏 9.3 / 稀疏 8.5 / 回执 8.0）
- Changed: 还没读到今天的聊天时，看到「今天还没读到聊天。」和「重新生成」。没有橙色叹号。青玉仍只在「导出」。护栏未改。
- Verified: `swift test --filter DailyReportWorkspaceContractTests` 8 个用例全绿；`swift build -c release`。走查：开今日小结 → 来源未验证看到「今天还没读到聊天。」和「重新生成」→ 没有橙色 → 「导出」仍是青玉。
- Next: 今日小结还要再来：总分 8.3，已到过 8.0。主动词/空气/短句都 ≥ 8，圈回执——跟进点「标记完成」后页上没留下刚才完成了哪条。

## Cycle 172 — 2026-09-14 — 待办

- Surface: 待办
- Files: `Sources/WeChatHUD/Views/DiscussionWorkspaceView.swift`、`Tests/WeChatHUDTests/DiscussionWorkspaceContractTests.swift`
- Before: 总分 8.2（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 8.8 / 状态戏 8.0 / 稀疏 8.0 / 回执 8.2）
- Debt picked: 选中后仍是「归属 / 截止时间 / 来源」三行说明书。
- After: 总分 8.4（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 8.8 / 状态戏 8.0 / 稀疏 9.5 / 回执 8.2）
- Changed: 选一条后看到「我来做」一类的一句现状，没有「归属 / 截止时间 / 来源」三行。「标记完成」仍是青玉。护栏未改。
- Verified: `swift test --filter DiscussionWorkspaceContractTests` 7 个用例全绿；`swift build -c release`。走查：开待办 → 选一条 → 看到「我来做」一类一句 → 没有「归属」三行 → 「标记完成」仍是青玉。
- Next: 待办已到 8.4，连续两刀 <0.3，换到今日小结。待办保持 in-progress。

## Cycle 171 — 2026-09-14 — 待办

- Surface: 待办
- Files: `Sources/WeChatHUD/Views/DiscussionWorkspaceView.swift`、`Tests/WeChatHUDTests/DiscussionWorkspaceContractTests.swift`
- Before: 总分 8.0（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 7.5 / 状态戏 8.0 / 稀疏 8.0 / 回执 8.2）
- Debt picked: 标记完成后「撤销」和关闭回执仍是系统 `.plain`。
- After: 总分 8.2（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 8.8 / 状态戏 8.0 / 稀疏 8.0 / 回执 8.2）
- Changed: 点「标记完成」后，「撤销」和关闭回执按下会让步。「标记完成」仍是青玉。护栏未改。
- Verified: `swift test --filter DiscussionWorkspaceContractTests` 6 个用例全绿；`swift build -c release`。走查：开待办 → 选一条 → 点「标记完成」→ 按下「撤销」缩放 → 「标记完成」仍是青玉。
- Next: 待办还要再来：总分 8.2，已到过 8.0。主动词/空气/短句都 ≥ 8，圈稀疏——选中后仍是「归属 / 截止时间 / 来源」三行说明书。

## Cycle 170 — 2026-09-14 — 关注谁
...
- Before: 总分 8.3（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 8.5 / 状态戏 8.0 / 稀疏 9.2 / 回执 8.0）
- Debt picked: 添加框读联系人失败仍是橙色系统原文。
- After: 总分 8.5（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 8.5 / 状态戏 9.3 / 稀疏 9.2 / 回执 8.0）
- Changed: 添加关注读不到人时看到「刚才没读到人。」和「再试一次」，没有橙色原文。青玉仍只在「添加关注」。护栏未改。
- Verified: `swift test --filter ContactsSettingsContractTests` 13 个用例全绿；`swift build -c release`。走查：开关注谁 → 添加关注 → 读失败时看到「刚才没读到人。」和「再试一次」→ 没有橙色 → 「添加关注」仍是青玉。
- Next: 关注谁总分 8.5，主动词/空气/短句 ≥ 8，标 done。换到待办。

## Cycle 169 — 2026-09-14 — 关注谁

- Surface: 关注谁
- Files: `Sources/WeChatHUD/Views/Settings/ContactsSettingsView.swift`、`Tests/WeChatHUDTests/ContactsSettingsContractTests.swift`
- Before: 总分 8.1（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 8.5 / 状态戏 8.0 / 稀疏 7.8 / 回执 8.0）
- Debt picked: 选中后右侧仍有「关注级别」三段，和页头徽章、名单分组重复。
- After: 总分 8.3（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 8.5 / 状态戏 8.0 / 稀疏 9.2 / 回执 8.0）
- Changed: 选一个人后，右侧没有「重点关注 / 关注 / 仅保留资料」三段。改级别走「编辑详情」或名单上的「变更级别」。青玉仍只在「添加关注」。护栏未改。
- Verified: `swift test --filter ContactsSettingsContractTests` 12 个用例全绿；`swift build -c release`。走查：开关注谁 → 选一个人 → 看到「整理范围」和「TA 是谁」，没有关注级别三段 → 点「编辑详情」→ 「添加关注」仍是青玉。
- Next: 关注谁还要再来：总分 8.3，已到过 8.0。主动词/空气/短句都 ≥ 8，圈状态戏——添加框空名单仍是系统小字，失败仍是橙色。

## Cycle 168 — 2026-09-14 — 首次引导

- Surface: 首次引导
- Files: `Sources/WeChatHUD/Views/FirstLaunchContactPicker.swift`、`Tests/WeChatHUDTests/OnboardingStepContractTests.swift`
- Before: 总分 8.3（主动词 8.2 / 空气 8.8 / 短句 8.0 / 物理 8.0 / 状态戏 8.0 / 稀疏 9.5 / 回执 8.2）
- Debt picked: 联系人行按下仍是系统 `.plain`。
- After: 总分 8.5（主动词 8.2 / 空气 8.8 / 短句 8.0 / 物理 9.2 / 状态戏 8.0 / 稀疏 9.5 / 回执 8.2）
- Changed: 「从一个人或一个群开始」下面的名单，按下会让步，不是系统 `.plain`。「开始使用」仍是青玉。护栏未改。
- Verified: `swift test --filter OnboardingStepContractTests` 17 个用例全绿；`swift build -c release`。走查：开首次引导 → 连上后到选择关注 → 看到「从一个人或一个群开始」→ 按下名单里的人缩放 → 「开始使用」仍是青玉。
- Next: 首次引导总分 8.5，主动词/空气/短句 ≥ 8，标 done。换到关注谁。

## Cycle 167 — 2026-09-14 — AI 服务

- Surface: AI 服务
- Files: `Sources/WeChatHUD/Views/Settings/AISettingsView.swift`、`Tests/WeChatHUDTests/AutopilotCopyConsistencyTests.swift`
- Before: 总分 8.4（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 9.4 / 状态戏 8.6 / 稀疏 8.0 / 回执 8.8）
- Debt picked: 「可以用」下面仍压着「改完会自动保存」长说明。
- After: 总分 8.5（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 9.4 / 状态戏 8.6 / 稀疏 9.0 / 回执 8.8）
- Changed: 开 AI 服务先看到「可以用」或「还不能用」和「确认能用」，下面不再压「改完会自动保存。相关聊天会发给这个服务来写摘要和草稿。」「确认能用」仍是青玉。护栏未改。
- Verified: `swift test --filter AutopilotCopyConsistencyTests` 72 个用例全绿；`swift build -c release`。走查：开 AI 服务 → 看到「可以用」或「还不能用」和「确认能用」→ 没有「改完会自动保存」→ 「确认能用」仍是青玉。
- Next: AI 服务总分 8.5，主动词/空气/短句 ≥ 8，标 done。换到首次引导。

## Cycle 166 — 2026-09-14 — 微信连接

- Surface: 微信连接
- Files: `Sources/WeChatHUD/Views/WeChatConnectionSetupView.swift`、`Tests/WeChatHUDTests/AutopilotCopyConsistencyTests.swift`
- Before: 总分 8.4（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 9.2 / 状态戏 8.7 / 稀疏 8.5 / 回执 9.0）
- Debt picked: 准备失败仍把系统错误原文写上卡片。
- After: 总分 8.5（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 9.2 / 状态戏 9.4 / 稀疏 8.5 / 回执 9.0）
- Changed: 准备失败看到「这次准备没有完成，请重试。」一类人话，不是系统错误原文。青玉仍只在「去选对话」。护栏未改。
- Verified: `swift test --filter AutopilotCopyConsistencyTests` 72 个用例全绿；`swift build -c release`。走查：准备失败 → 看到「这次准备没有完成，请重试。」→ 「去选对话」仍是青玉。
- Next: 微信连接总分 8.5，主动词/空气/短句 ≥ 8，标 done。换到 AI 服务。

## Cycle 165 — 2026-09-14 — AI 服务

- Surface: AI 服务
- Files: `Sources/WeChatHUD/Views/Settings/AISettingsView.swift`、`Tests/WeChatHUDTests/AutopilotCopyConsistencyTests.swift`
- Before: 总分 8.3（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 9.4 / 状态戏 8.6 / 稀疏 8.0 / 回执 8.0）
- Debt picked: 换了「用哪家」后刚才确认过的结果被清掉却没说话。
- After: 总分 8.4（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 9.4 / 状态戏 8.6 / 稀疏 8.0 / 回执 8.8）
- Changed: 按下「自己填」或「常用服务」后，看到「换了来源，还要再确认。」「确认能用」仍是青玉。护栏未改。
- Verified: `swift test --filter AutopilotCopyConsistencyTests` 71 个用例全绿；`swift build -c release`。走查：开 AI 服务 → 按下「自己填」→ 看到「换了来源，还要再确认。」→ 「确认能用」仍是青玉。
- Next: AI 服务已到 8.4，连续两刀 <0.3，换到微信连接。AI 服务保持 in-progress。

## Cycle 164 — 2026-09-14 — AI 服务

- Surface: AI 服务
- Files: `Sources/WeChatHUD/Views/Settings/AISettingsView.swift`、`Tests/WeChatHUDTests/AutopilotCopyConsistencyTests.swift`
- Before: 总分 8.2（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 9.4 / 状态戏 8.0 / 稀疏 8.0 / 回执 8.0）
- Debt picked: 搜模型没有结果是空白。
- After: 总分 8.3（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 9.4 / 状态戏 8.6 / 稀疏 8.0 / 回执 8.0）
- Changed: 展开模型后搜不到时看到「没有这个模型。」「确认能用」仍是青玉。护栏未改。
- Verified: `swift test --filter AutopilotCopyConsistencyTests` 70 个用例全绿；`swift build -c release`。走查：开 AI 服务 → 展开模型列表 → 搜索对不上 → 看到「没有这个模型。」→ 「确认能用」仍是青玉。
- Next: AI 服务还要再来：总分 8.3，已到过 8.0。主动词/空气/短句都 ≥ 8，圈回执——换了「用哪家」后刚才确认过的结果被清掉却没说话。

## Cycle 163 — 2026-09-14 — 微信连接

- Surface: 微信连接
- Files: `Sources/WeChatHUD/Views/WeChatConnectionSetupView.swift`、`Tests/WeChatHUDTests/AutopilotCopyConsistencyTests.swift`
- Before: 总分 8.3（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 9.2 / 状态戏 8.0 / 稀疏 8.5 / 回执 9.0）
- Debt picked: 出错仍是橙色系统 Label。
- After: 总分 8.4（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 9.2 / 状态戏 8.7 / 稀疏 8.5 / 回执 9.0）
- Changed: 出错看到「这次没重新打开助手，请再试一次。」没有橙色叹号。青玉仍只在「去选对话」。护栏未改。
- Verified: `swift test --filter AutopilotCopyConsistencyTests` 69 个用例全绿；`swift build -c release`。走查：重新打开助手失败 → 看到「这次没重新打开助手，请再试一次。」没有橙色叹号 → 「去选对话」仍是青玉。
- Next: 微信连接已到 8.4，连续两刀 <0.3，换到 AI 服务。微信连接保持 in-progress。

## Cycle 162 — 2026-09-14 — 微信连接

- Surface: 微信连接
- Files: `Sources/WeChatHUD/Views/WeChatConnectionSetupView.swift`、`Tests/WeChatHUDTests/AutopilotCopyConsistencyTests.swift`
- Before: 总分 8.2（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 8.6 / 状态戏 8.0 / 稀疏 8.5 / 回执 9.0）
- Debt picked: 准备密钥时「取消」仍是系统链接。
- After: 总分 8.3（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 9.2 / 状态戏 8.0 / 稀疏 8.5 / 回执 9.0）
- Changed: 等微信重新登录时，「取消」按下会让步，不是系统链接。青玉仍只在「去选对话」。护栏未改。
- Verified: `swift test --filter AutopilotCopyConsistencyTests` 68 个用例全绿；`swift build -c release`。走查：准备密钥等到重新登录 → 按下「取消」缩放 → 「去选对话」仍是青玉。
- Next: 微信连接还要再来：总分 8.3，已到过 8.0。主动词/空气/短句都 ≥ 8，圈状态戏——出错仍是橙色系统 Label。

## Cycle 161 — 2026-09-14 — AI 服务

- Surface: AI 服务
- Files: `Sources/WeChatHUD/Views/Settings/AISettingsView.swift`、`Tests/WeChatHUDTests/AutopilotCopyConsistencyTests.swift`
- Before: 总分 8.2（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 9.2 / 状态戏 8.0 / 稀疏 8.0 / 回执 8.0）
- Debt picked: 高级里滑杆数字仍是裸 system 字。
- After: 总分 8.2（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 9.4 / 状态戏 8.0 / 稀疏 8.0 / 回执 8.0）
- Changed: 「回复最长写多少」和「写得更随意一些」旁边的数字是工作台字，不再是 12pt 等宽系统字。「确认能用」仍是青玉。护栏未改。
- Verified: `swift test --filter AutopilotCopyConsistencyTests` 67 个用例全绿；`swift build -c release`。走查：开 AI 服务 → 打开高级设置 → 看到「回复最长写多少」数字是工作台字 → 「确认能用」仍在。
- Next: AI 服务已到 8.2，连续两刀 <0.3，换到微信连接。AI 服务保持 in-progress。

## Cycle 160 — 2026-09-14 — AI 服务

- Surface: AI 服务
- Files: `Sources/WeChatHUD/Views/Settings/AISettingsView.swift`、`Tests/WeChatHUDTests/AutopilotCopyConsistencyTests.swift`
- Before: 总分 8.1（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 8.6 / 状态戏 8.0 / 稀疏 8.0 / 回执 8.0）
- Debt picked: 「用哪家」仍是系统蓝分段。
- After: 总分 8.2（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 9.2 / 状态戏 8.0 / 稀疏 8.0 / 回执 8.0）
- Changed: 「用哪家」改成可按的「常用服务 / 自己填」，选中有洗层，不是系统蓝分段。「确认能用」仍是青玉。护栏未改。
- Verified: `swift test --filter AutopilotCopyConsistencyTests` 67 个用例全绿；`swift build -c release`。走查：开 AI 服务 → 看到「确认能用」→ 按下「自己填」缩放并选中 → 「确认能用」仍是青玉。
- Next: AI 服务还要再来：总分 8.2，已到过 8.0。主动词/空气/短句都 ≥ 8，圈物理——高级里滑杆数字仍是裸 system 字。

## Cycle 159 — 2026-09-14 — 自动回复设置
...
- Before: 总分 8.4（主动词 8.0 / 空气 8.2 / 短句 8.0 / 物理 9.2 / 状态戏 8.5 / 稀疏 8.3 / 回执 8.2）
- Debt picked: 清除历史成功没说话。
- After: 总分 8.5（主动词 8.0 / 空气 8.2 / 短句 8.0 / 物理 9.2 / 状态戏 8.5 / 稀疏 8.3 / 回执 9.2）
- Changed: 点「清除历史」并确认后，看到「记录已清除。」自动发送默认关未改。护栏未改。
- Verified: `swift test --filter AutopilotCopyConsistencyTests` 66 个用例全绿；`swift build -c release`。走查：开自动回复设置 → 打开高级设置 → 有记录时点「清除历史」→ 确认「清除」→ 看到「记录已清除。」「查看待确认回复」仍在。
- Next: 自动回复设置总分 8.5，主动词/空气/短句 ≥ 8，标 done。换到 AI 服务。

## Cycle 158 — 2026-09-14 — 自动回复设置

- Surface: 自动回复设置
- Files: `Sources/WeChatHUD/Views/Settings/AutopilotSettingsView.swift`、`Tests/WeChatHUDTests/AutopilotCopyConsistencyTests.swift`
- Before: 总分 8.3（主动词 8.0 / 空气 8.2 / 短句 8.0 / 物理 8.7 / 状态戏 8.5 / 稀疏 8.3 / 回执 8.2）
- Debt picked: 连发窗口仍是系统菜单。
- After: 总分 8.4（主动词 8.0 / 空气 8.2 / 短句 8.0 / 物理 9.2 / 状态戏 8.5 / 稀疏 8.3 / 回执 8.2）
- Changed: 「连发时等几秒一起回」改成可按的 5/10/15/30 秒，选中有洗层，不是系统菜单。自动发送默认关未改。护栏未改。
- Verified: `swift test --filter AutopilotCopyConsistencyTests` 65 个用例全绿；`swift build -c release`。走查：开自动回复设置 → 看到「连发时等几秒一起回」→ 按下「15 秒」缩放并选中 → 「查看待确认回复」仍在。
- Next: 自动回复设置还要再来：总分 8.4，已到过 8.0。主动词/空气/短句都 ≥ 8，圈回执——清除历史成功没说话。

## Cycle 157 — 2026-09-14 — 待确认回复

- Surface: 待确认回复
- Files: `Sources/WeChatHUD/Views/ApprovalWorkspaceView.swift`、`Tests/WeChatHUDTests/AutopilotCopyConsistencyTests.swift`
- Before: 总分 8.4（主动词 8.0 / 空气 8.2 / 短句 8.0 / 物理 8.5 / 状态戏 8.5 / 稀疏 8.5 / 回执 8.5）
- Debt picked: 发送结果待核对仍画成功对勾。
- After: 总分 8.5（主动词 8.0 / 空气 8.2 / 短句 8.0 / 物理 8.5 / 状态戏 8.5 / 稀疏 8.5 / 回执 9.0）
- Changed: 「确认发送」发出去才有对勾；对不上时看到「发送结果待核对」，「保存修改」失败看到「草稿没有保存，请重试。」没有对勾。自动发送默认关未改。护栏未改。
- Verified: `swift test --filter AutopilotCopyConsistencyTests` 64 个用例全绿；`swift build -c release`。走查：点「确认发送」→ 发出去有对勾；对不上没有对勾，看到「发送结果待核对」。点「保存修改」→ 「已保存草稿」。
- Next: 待确认回复总分 8.5，主动词/空气/短句 ≥ 8，标 done。换到自动回复设置。

## Cycle 156 — 2026-09-14 — 自动回复设置

- Surface: 自动回复设置
- Files: `Sources/WeChatHUD/Views/Settings/AutopilotSettingsView.swift`、`Tests/WeChatHUDTests/AutopilotCopyConsistencyTests.swift`
- Before: 总分 8.2（主动词 8.0 / 空气 8.2 / 短句 8.0 / 物理 8.7 / 状态戏 8.0 / 稀疏 8.3 / 回执 8.2）
- Debt picked: 排除空名单仍只是一句空话。
- After: 总分 8.3（主动词 8.0 / 空气 8.2 / 短句 8.0 / 物理 8.7 / 状态戏 8.5 / 稀疏 8.3 / 回执 8.2）
- Changed: 空名单改成「还没有排除的人。」有人可加时「添加排除对象」就在这句话下面；没人时「去关注谁」。自动发送默认关未改。护栏未改。
- Verified: `swift test --filter AutopilotCopyConsistencyTests` 63 个用例全绿；`swift build -c release`。走查：开自动回复设置 → 打开高级设置 → 看到「还没有排除的人。」→ 有关注的人时按下「添加排除对象」；名单空且没人可加时按下「去关注谁」→ 「查看待确认回复」仍在。
- Next: 自动回复设置已到 8.3，连续两刀 <0.3，换到待确认回复。自动回复设置保持 in-progress。

## Cycle 155 — 2026-09-14 — 自动回复设置

- Surface: 自动回复设置
- Files: `Sources/WeChatHUD/Views/Settings/AutopilotSettingsView.swift`、`Tests/WeChatHUDTests/AutopilotCopyConsistencyTests.swift`
- Before: 总分 8.1（主动词 8.0 / 空气 8.2 / 短句 8.0 / 物理 8.2 / 状态戏 8.0 / 稀疏 8.3 / 回执 8.2）
- Debt picked: 发送键仍是系统蓝分段控件。
- After: 总分 8.2（主动词 8.0 / 空气 8.2 / 短句 8.0 / 物理 8.7 / 状态戏 8.0 / 稀疏 8.3 / 回执 8.2）
- Changed: 高级里「微信发送键」改成可按的 Cmd+Enter / Enter，选中有洗层，不是系统蓝分段。自动发送默认关未改。护栏未改。
- Verified: `swift test --filter AutopilotCopyConsistencyTests` 63 个用例全绿；`swift build -c release`。走查：开自动回复设置 → 打开高级设置 → 看到「微信发送键」→ 按下「Enter」缩放并选中 → 「查看待确认回复」仍在。
- Next: 自动回复设置还要再来：总分 8.2，已到过 8.0。主动词/空气/短句都 ≥ 8，圈状态戏——排除空名单仍只是一句空话。

## Cycle 154 — 2026-09-14 — 待确认回复

- Surface: 待确认回复
- Files: `Sources/WeChatHUD/Views/ApprovalWorkspaceView.swift`、`Tests/WeChatHUDTests/AutopilotCopyConsistencyTests.swift`
- Before: 总分 8.3（主动词 8.0 / 空气 8.2 / 短句 8.0 / 物理 8.0 / 状态戏 8.5 / 稀疏 8.5 / 回执 8.5）
- Debt picked: 确认框「返回」仍是系统按钮。
- After: 总分 8.4（主动词 8.0 / 空气 8.2 / 短句 8.0 / 物理 8.5 / 状态戏 8.5 / 稀疏 8.5 / 回执 8.5）
- Changed: 点「确认发送」后，「返回修改」按下会让步，主按钮仍是青玉发出去。自动发送默认关未改。护栏未改。
- Verified: `swift test --filter AutopilotCopyConsistencyTests` 62 个用例全绿；`swift build -c release`。走查：点「确认发送」→ 按下「返回修改」缩放 → 松开回到回复；发出去仍是青玉。
- Next: 待确认回复已到 8.4，连续两刀 <0.3，换到自动回复设置。待确认回复保持 in-progress。

## Cycle 153 — 2026-09-14 — 待确认回复

- Surface: 待确认回复
- Files: `Sources/WeChatHUD/Views/ApprovalWorkspaceView.swift`、`Tests/WeChatHUDTests/AutopilotCopyConsistencyTests.swift`
- Before: 总分 8.1（主动词 8.0 / 空气 8.2 / 短句 8.0 / 物理 8.0 / 状态戏 7.5 / 稀疏 8.5 / 回执 8.5）
- Debt picked: 立即发送找不到队列项仍写「队列项已不存在」。
- After: 总分 8.3（主动词 8.0 / 空气 8.2 / 短句 8.0 / 物理 8.0 / 状态戏 8.5 / 稀疏 8.5 / 回执 8.5）
- Changed: 点「立即发送」时如果这条已经不在，看到「这条已经不在队列里。」自动发送默认关未改。护栏未改。
- Verified: `swift test --filter AutopilotCopyConsistencyTests` 61 个用例全绿；`swift build -c release`。走查：即将发送 → 点「立即发送」→ 队列已空时看到「这条已经不在队列里。」
- Next: 待确认回复还要再来：总分 8.3，已到过 8.0。主动词/空气/短句都 ≥ 8，圈物理——确认框「返回」仍是系统按钮。

## Cycle 152 — 2026-09-14 — 岛·紧凑/peek

- Surface: 岛·紧凑/peek
- Files: `Sources/WeChatHUD/Views/CompactInboxBar.swift`、`Tests/WeChatHUDTests/AutopilotCopyConsistencyTests.swift`
- Before: 总分 8.4（主动词 8.2 / 空气 8.2 / 短句 8.4 / 物理 8.2 / 状态戏 8.5 / 稀疏 8.5 / 回执 8.5）
- Debt picked: 双翼按下有缩放，悬停没有洗层。
- After: 总分 8.5（主动词 8.2 / 空气 8.2 / 短句 8.4 / 物理 8.8 / 状态戏 8.5 / 稀疏 8.5 / 回执 8.5）
- Changed: 悬停左翼或右翼会洗一层岛墨。弹簧和 peek 宽度未改。护栏未改。
- Verified: `swift test --filter AutopilotCopyConsistencyTests` 60 个用例全绿；`swift test --filter CompactErrorAffordanceTests` 8 个用例全绿；`swift test --filter IslandPeekTests` 12 个用例全绿；`swift build -c release`。走查：紧凑岛 → 悬停左翼洗层 → 点右翼仍「打开今天」。
- Next: 岛·紧凑/peek 总分 8.5，主动词/空气/短句 ≥ 8，标 done。换到待确认回复。

## Cycle 151 — 2026-09-14 — 待确认回复

- Surface: 待确认回复
- Files: `Sources/WeChatHUD/Views/ApprovalWorkspaceView.swift`、`Tests/WeChatHUDTests/AutopilotCopyConsistencyTests.swift`
- Before: 总分 8.0（主动词 8.0 / 空气 8.2 / 短句 8.0 / 物理 8.0 / 状态戏 7.5 / 稀疏 8.5 / 回执 7.5）
- Debt picked: 取消即将发送仍写「已取消即将发送的回复」。
- After: 总分 8.1（主动词 8.0 / 空气 8.2 / 短句 8.0 / 物理 8.0 / 状态戏 7.5 / 稀疏 8.5 / 回执 8.5）
- Changed: 点「取消」留下「这条不发了。」自动发送默认关未改。护栏未改。
- Verified: `swift test --filter AutopilotCopyConsistencyTests` 59 个用例全绿；`swift build -c release`。走查：即将发送 → 点「取消」→ 看到「这条不发了。」
- Next: 待确认回复已到 8.1，连续两刀 <0.3，换到岛·紧凑/peek。待确认回复保持 in-progress。

## Cycle 150 — 2026-09-14 — 待确认回复

- Surface: 待确认回复
- Files: `Sources/WeChatHUD/Views/ApprovalWorkspaceView.swift`、`Tests/WeChatHUDTests/AutopilotCopyConsistencyTests.swift`
- Before: 总分 7.8（主动词 8.0 / 空气 8.2 / 短句 8.0 / 物理 8.0 / 状态戏 7.5 / 稀疏 7.0 / 回执 7.5）
- Debt picked: 即将发送仍并排取消/立即发送。
- After: 总分 8.0（主动词 8.0 / 空气 8.2 / 短句 8.0 / 物理 8.0 / 状态戏 7.5 / 稀疏 8.5 / 回执 7.5）
- Changed: 「即将发送」只留青玉「立即发送」；「取消」是安静次要。自动发送默认关未改。护栏未改。
- Verified: `swift test --filter AutopilotCopyConsistencyTests` 58 个用例全绿；`swift test --filter ApprovalWorkspaceTests` 6 个用例全绿；`swift build -c release`。走查：有即将发送 → 看到「立即发送」是主按钮 → 「取消」是次要字。
- Next: 待确认回复还要再来：总分 8.0，本轮第一次到过 8.0。主动词/空气/短句都 ≥ 8，圈回执——取消即将发送仍写「已取消即将发送的回复」。

## Cycle 149 — 2026-09-14 — 岛·紧凑/peek

- Surface: 岛·紧凑/peek
- Files: `Sources/WeChatHUD/Data/CompactIslandPolicy.swift`、`Tests/WeChatHUDTests/CompactIslandPolicyTests.swift`
- Before: 总分 8.3（主动词 8.2 / 空气 8.2 / 短句 8.4 / 物理 8.2 / 状态戏 8.0 / 稀疏 8.5 / 回执 8.5）
- Debt picked: 连不上时 peek 只写「连不上」，没有下一步。
- After: 总分 8.4（主动词 8.2 / 空气 8.2 / 短句 8.4 / 物理 8.2 / 状态戏 8.5 / 稀疏 8.5 / 回执 8.5）
- Changed: 连不上时悬停 peek 看到「去连接」，点左翼仍去微信连接。弹簧和 peek 宽度未改。护栏未改。
- Verified: `swift test --filter CompactIslandPolicyTests` 13 个用例全绿；`swift test --filter CompactErrorAffordanceTests` 8 个用例全绿；`swift build -c release`。走查：连不上 → 悬停 peek 看到「去连接」→ 点左翼打开微信连接。
- Next: 岛·紧凑/peek 已到 8.4，连续两刀 <0.3，换到待确认回复。紧凑保持 in-progress。待确认回复从未到过 8.0，回扫时留下。

## Cycle 148 — 2026-09-14 — 岛·紧凑/peek

- Surface: 岛·紧凑/peek
- Files: `Sources/WeChatHUD/Views/CompactInboxBar.swift`、`Tests/WeChatHUDTests/CompactErrorAffordanceTests.swift`、`Tests/WeChatHUDTests/AutopilotCopyConsistencyTests.swift`
- Before: 总分 8.2（主动词 8.2 / 空气 8.2 / 短句 8.4 / 物理 8.2 / 状态戏 8.0 / 稀疏 8.5 / 回执 8.0）
- Debt picked: 点右翼打开今天，岛上没回音。
- After: 总分 8.3（主动词 8.2 / 空气 8.2 / 短句 8.4 / 物理 8.2 / 状态戏 8.0 / 稀疏 8.5 / 回执 8.5）
- Changed: 点右翼打开今天，留下「已经打开今天。」薄荷回执。弹簧和 peek 宽度未改。护栏未改。
- Verified: `swift test --filter CompactErrorAffordanceTests` 8 个用例全绿；`swift test --filter AutopilotCopyConsistencyTests` 57 个用例全绿；`swift build -c release`。走查：紧凑岛 → 点右翼 → 打开今天 → 看到「已经打开今天。」
- Next: 岛·紧凑/peek 还要再来：总分 8.3，已到过 8.0。主动词/空气/短句都 ≥ 8，圈状态戏——连不上时 peek 只写「连不上」，没有下一步。

## Cycle 147 — 2026-09-14 — 岛·通知横幅

- Surface: 岛·通知横幅
- Files: `Sources/WeChatHUD/Views/NotificationBannerView.swift`、`Sources/WeChatHUD/Views/HUDRootView.swift`、`Sources/WeChatHUD/App/PanelState.swift`、`Tests/WeChatHUDTests/NotificationBannerContentTests.swift`、`Tests/WeChatHUDTests/NotificationBannerClickTests.swift`、`Tests/WeChatHUDTests/AutopilotCopyConsistencyTests.swift`
- Before: 总分 8.4（主动词 8.2 / 空气 8.3 / 短句 8.1 / 物理 8.7 / 状态戏 8.0 / 稀疏 8.4 / 回执 8.0）
- Debt picked: 点关闭横幅消失，不知道消息还在。
- After: 总分 8.5（主动词 8.2 / 空气 8.3 / 短句 8.1 / 物理 8.7 / 状态戏 8.0 / 稀疏 8.4 / 回执 8.5）
- Changed: 点「关闭」岛收回去，留下「还在收件箱。」薄荷回执，不是警告三角。弹簧和测量未改。护栏未改。
- Verified: `swift test --filter NotificationBannerContentTests` 18 个用例全绿；`swift test --filter NotificationBannerClickTests` 6 个用例全绿；`swift test --filter AutopilotCopyConsistencyTests` 56 个用例全绿；`swift test --filter IslandInteractionTests` 25 个用例全绿；`swift build -c release`。走查：看到消息 → 点关闭 → 岛收成紧凑，看到「还在收件箱。」
- Next: 岛·通知横幅总分 8.5，主动词/空气/短句 ≥ 8，标 done。换到岛·紧凑/peek。

## Cycle 146 — 2026-09-14 — 怎么用

- Surface: 怎么用
- Files: `Sources/WeChatHUD/Views/CompanionGuideView.swift`、`Tests/WeChatHUDTests/CompanionGuideContractTests.swift`
- Before: 总分 8.2（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 8.0 / 状态戏 8.0 / 稀疏 8.5 / 回执 7.5）
- Debt picked: 「重新打开引导」点了没回音。
- After: 总分 8.3（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 8.0 / 状态戏 8.0 / 稀疏 8.5 / 回执 8.5）
- Changed: 点「重新打开引导」先留下「引导会再走一遍。」再打开引导。护栏未改。
- Verified: `swift test --filter CompanionGuideContractTests` 11 个用例全绿；`swift build -c release`。走查：开怎么用 → 看到「先连接微信」和「连接微信」→ 点「还要看其余说明」→ 点「每天怎么用」→ 点「重新打开引导」→ 看到「引导会再走一遍。」
- Next: 怎么用已到 8.3，连续两刀 <0.3，换到岛·通知横幅。怎么用保持 in-progress。

## Cycle 145 — 2026-09-14 — 怎么用

- Surface: 怎么用
- Files: `Sources/WeChatHUD/Views/CompanionGuideView.swift`、`Tests/WeChatHUDTests/CompanionGuideContractTests.swift`
- Before: 总分 8.0（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 8.0 / 状态戏 8.0 / 稀疏 6.7 / 回执 7.5）
- Debt picked: 展开后仍套描边封面卡。
- After: 总分 8.2（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 8.0 / 状态戏 8.0 / 稀疏 8.5 / 回执 7.5）
- Changed: 点开「每天怎么用」直接是条目，不再套描边封面卡。护栏未改。
- Verified: `swift test --filter CompanionGuideContractTests` 10 个用例全绿；`swift build -c release`。走查：开怎么用 → 看到「先连接微信」和「连接微信」→ 点「还要看其余说明」→ 点「每天怎么用」→ 看到「从「今天」开始」，不是封面卡。
- Next: 怎么用还要再来：总分 8.2，已到过 8.0。主动词/空气/短句都 ≥ 8，圈回执——「重新打开引导」点了没回音。

## Cycle 144 — 2026-09-14 — 怎么用

- Surface: 怎么用
- Files: `Sources/WeChatHUD/Views/CompanionGuideView.swift`、`Tests/WeChatHUDTests/CompanionGuideContractTests.swift`
- Before: 总分 7.7（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 8.0 / 状态戏 6.0 / 稀疏 6.7 / 回执 7.5）
- Debt picked: 「版本信息未提供」仍是实现句。
- After: 总分 8.0（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 8.0 / 状态戏 8.0 / 稀疏 6.7 / 回执 7.5）
- Changed: 没有版本号时写「还没有版本号。」没有「版本信息未提供」。护栏未改。
- Verified: `swift test --filter CompanionGuideContractTests` 9 个用例全绿；`swift build -c release`。走查：开怎么用 → 看到「先连接微信」和「连接微信」→ 点「还要看其余说明」→ 点「关于」→ 看到版本或「还没有版本号」。
- Next: 怎么用还要再来：总分 8.0，已到过 8.0。主动词/空气/短句都 ≥ 8，圈稀疏——展开后仍套描边封面卡。

## Cycle 143 — 2026-09-14 — 怎么用

- Surface: 怎么用
- Files: `Sources/WeChatHUD/Views/CompanionGuideView.swift`、`Tests/WeChatHUDTests/CompanionGuideContractTests.swift`
- Before: 总分 7.5（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 8.0 / 状态戏 6.0 / 稀疏 6.7 / 回执 5.5）
- Debt picked: 「检查更新」点了没回音。
- After: 总分 7.7（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 8.0 / 状态戏 6.0 / 稀疏 6.7 / 回执 7.5）
- Changed: 点「检查更新」后写「正在看有没有新版本。」或「已经是最新。」不再跳走。护栏未改。
- Verified: `swift test --filter CompanionGuideContractTests` 8 个用例全绿；`swift build -c release`。走查：开怎么用 → 看到「先连接微信」和「连接微信」→ 点「还要看其余说明」→ 点「关于」→ 按下「检查更新」→ 看到「正在看有没有新版本」或「已经是最新」。
- Next: 怎么用还要再来：总分 7.7，从未到过 8.0。主动词/空气/短句都 ≥ 8，圈状态戏——「版本信息未提供」仍是实现句。

## Cycle 142 — 2026-09-14 — 怎么用

- Surface: 怎么用
- Files: `Sources/WeChatHUD/Views/CompanionGuideView.swift`、`Tests/WeChatHUDTests/CompanionGuideContractTests.swift`
- Before: 总分 7.3（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 6.5 / 状态戏 6.0 / 稀疏 6.7 / 回执 5.5）
- Debt picked: 其余说明里的按钮仍是系统描边。
- After: 总分 7.5（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 8.0 / 状态戏 6.0 / 稀疏 6.7 / 回执 5.5）
- Changed: 「检查连接」「重新打开引导」按下会缩，不再是系统描边。不是青玉。护栏未改。
- Verified: `swift test --filter CompanionGuideContractTests` 7 个用例全绿；`swift build -c release`。走查：开怎么用 → 看到「先连接微信」和「连接微信」→ 点「还要看其余说明」→ 点「遇到问题时」→ 按下「检查连接」会让步。
- Next: 怎么用还要再来：总分 7.5，从未到过 8.0。主动词/空气/短句都 ≥ 8，圈回执——「检查更新」点了没回音。

## Cycle 141 — 2026-09-14 — 怎么用

- Surface: 怎么用
- Files: `Sources/WeChatHUD/Views/CompanionGuideView.swift`、`Tests/WeChatHUDTests/CompanionGuideContractTests.swift`
- Before: 总分 7.1（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 6.5 / 状态戏 6.0 / 稀疏 4.7 / 回执 5.5）
- Debt picked: 点开其余说明仍一次倒出五张卡。
- After: 总分 7.3（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 6.5 / 状态戏 6.0 / 稀疏 6.7 / 回执 5.5）
- Changed: 点「还要看其余说明」先看到折叠条「每天怎么用」。不是一次铺开五张卡。护栏未改。
- Verified: `swift test --filter CompanionGuideContractTests` 6 个用例全绿；`swift build -c release`。走查：开怎么用 → 看到「先连接微信」和「连接微信」→ 点「还要看其余说明」→ 看到折叠的「每天怎么用」，不是五张卡。
- Next: 怎么用还要再来：总分 7.3，从未到过 8.0。主动词/空气/短句都 ≥ 8，圈物理——其余说明里的按钮仍是系统描边。

## Cycle 140 — 2026-09-14 — 怎么用

- Surface: 怎么用
- Files: `Sources/WeChatHUD/Views/CompanionGuideView.swift`、`Tests/WeChatHUDTests/CompanionGuideContractTests.swift`
- Before: 总分 6.8（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 4.5 / 状态戏 6.0 / 稀疏 4.7 / 回执 5.5）
- Debt picked: 「连接微信」仍是系统描边按钮。
- After: 总分 7.1（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 6.5 / 状态戏 6.0 / 稀疏 4.7 / 回执 5.5）
- Changed: 「连接微信」按下会缩，不再是系统描边。不是青玉。护栏未改。
- Verified: `swift test --filter CompanionGuideContractTests` 6 个用例全绿；`swift build -c release`。走查：开怎么用 → 看到「先连接微信」→ 按下「连接微信」会让步。
- Next: 怎么用还要再来：总分 7.1，从未到过 8.0。主动词/空气/短句都 ≥ 8，圈稀疏——点开其余说明仍一次倒出五张卡。

## Cycle 139 — 2026-09-14 — 怎么用

- Surface: 怎么用
- Files: `Sources/WeChatHUD/Views/CompanionGuideView.swift`、`Tests/WeChatHUDTests/CompanionGuideContractTests.swift`
- Before: 总分 6.6（主动词 8.0 / 空气 7.0 / 短句 8.0 / 物理 4.5 / 状态戏 6.0 / 稀疏 4.7 / 回执 5.5）
- Debt picked: 三步标题仍是系统 semibold，和页头抢一层。
- After: 总分 6.8（主动词 8.0 / 空气 8.0 / 短句 8.0 / 物理 4.5 / 状态戏 6.0 / 稀疏 4.7 / 回执 5.5）
- Changed: 三步标题用工作台字，不再是系统 semibold。没有青玉主按钮。护栏未改。
- Verified: `swift test --filter CompanionGuideContractTests` 5 个用例全绿；`swift build -c release`。走查：开怎么用 → 看到「先连接微信」→ 看到「连接微信」和「选择关注的人」→ 标题不是系统加粗块。
- Next: 怎么用还要再来：总分 6.8，从未到过 8.0。主动词/空气/短句都 ≥ 8，圈物理——「连接微信」仍是系统描边按钮。

## Cycle 138 — 2026-09-14 — 怎么用

- Surface: 怎么用
- Files: `Sources/WeChatHUD/Views/CompanionGuideView.swift`、`Tests/WeChatHUDTests/CompanionGuideContractTests.swift`
- Before: 总分 6.3（主动词 6.5 / 空气 7.0 / 短句 8.0 / 物理 4.5 / 状态戏 6.0 / 稀疏 4.7 / 回执 5.5）
- Debt picked: 三步并排三个同等按钮。
- After: 总分 6.6（主动词 8.0 / 空气 7.0 / 短句 8.0 / 物理 4.5 / 状态戏 6.0 / 稀疏 4.7 / 回执 5.5）
- Changed: 打开只看到一个「连接微信」。后两步只说事，不再各放一个按钮。护栏未改。
- Verified: `swift test --filter CompanionGuideContractTests` 5 个用例全绿；`swift build -c release`。走查：开怎么用 → 看到「先连接微信」→ 看到「连接微信」→ 没有「选择对话」和「打开今天」按钮。
- Next: 怎么用还要再来：总分 6.6，从未到过 8.0。圈空气——三步标题仍是系统 semibold，和页头抢一层。
