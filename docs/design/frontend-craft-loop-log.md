...
| 7 | AI 服务 | in-progress | 8.4 | 换来源会请再确认。已到 8.0，连续两刀 <0.3 |
| 8 | 微信连接 | in-progress | 8.4 | 出错不再是橙色叹号。已到 8.0，连续两刀 <0.3。本刀：微信连接 |
