...
一刀一节，新的写在最上面。
AI 服务总分 7.6、从未到过 8.0，留下。自动回复设置 8.1、已到过 8.0 且连续两刀 <0.3 后换到本页。待确认回复 7.8、从未到过 8.0，回扫时留下。
...
| 7 | AI 服务 | in-progress | 7.6 | 确认失败已收成人话；确认中仍可能露出已保存，滑杆仍是裸 system 字。从未到过 8.0 |
| 8 | 微信连接 | queued | — | |
| 9 | 首次引导 | queued | — | |
| 10 | 关注谁 | queued | — | |
