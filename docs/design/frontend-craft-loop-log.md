...
一刀一节，新的写在最上面。
AI 服务总分 7.5、从未到过 8.0，留下。自动回复设置 8.1、已到过 8.0 且连续两刀 <0.3 后换到本页。待确认回复 7.8、从未到过 8.0，回扫时留下。
...
| 7 | AI 服务 | in-progress | 7.5 | 自己填已露出接到哪；滑杆仍是裸 system 字，确认失败仍可能带 HTTP。从未到过 8.0 |
| 8 | 微信连接 | queued | — | |
| 9 | 首次引导 | queued | — | |
| 10 | 关注谁 | queued | — | |
