...
Run: `cd /Users/lilei/wechatcli/WeChatHUD && swift build 2>&1 | tail -5`
...
Run: `cd /Users/lilei/wechatcli/WeChatHUD && swift build 2>&1 | tail -10`
Expected: `Build complete!`

- [ ] **Step 4: Run tests to make sure nothing is broken**

Run: `cd /Users/lilei/wechatcli/WeChatHUD && swift test 2>&1 | tail -20`
...
```bash
cd /Users/lilei/wechatcli/WeChatHUD && swift package clean && swift build 2>&1 | tail -10
```

- [ ] **Step 2: Run all tests**

```bash
cd /Users/lilei/wechatcli/WeChatHUD && swift test 2>&1 | grep -E '(Test Suite|Executed|failed|skipped)'
```
