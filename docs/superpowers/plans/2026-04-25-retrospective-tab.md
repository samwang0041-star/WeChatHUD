...
- All file paths are absolute from repo root (`/Users/lilei/wechatcli/WeChatHUD/`).
...
```bash
grep -n "init(" /Users/lilei/wechatcli/WeChatHUD/Sources/WeChatHUD/Data/HUDStore.swift | head -5
grep -n "CREATE TABLE IF NOT EXISTS" /Users/lilei/wechatcli/WeChatHUD/Sources/WeChatHUD/Data/HUDStore.swift | head -10
```
...
```bash
cd /Users/lilei/wechatcli/WeChatHUD && swift build 2>&1 | grep -E "error:|warning:" | grep -v "Sendable" | head -10
```
...
```bash
cd /Users/lilei/wechatcli/WeChatHUD && swift test --filter HUDStoreTests 2>&1 | tail -20
```
...
```bash
cd /Users/lilei/wechatcli/WeChatHUD && swift build 2>&1 | grep "error:" | head -10
```
...
```bash
cd /Users/lilei/wechatcli/WeChatHUD && swift build 2>&1 | grep "error:" | head -5
...
```bash
cd /Users/lilei/wechatcli/WeChatHUD && swift test --filter HUDStoreRetrospectiveTests 2>&1 | tail -30
```
...
```bash
cd /Users/lilei/wechatcli/WeChatHUD && swift test --filter TextSimilarityTests 2>&1 | tail -10
```
...
```bash
cd /Users/lilei/wechatcli/WeChatHUD && swift test --filter TextSimilarityTests 2>&1 | tail -15
```
...
```bash
cd /Users/lilei/wechatcli/WeChatHUD && swift test --filter RedactorTests 2>&1 | tail -15
```
...
```bash
cd /Users/lilei/wechatcli/WeChatHUD && swift test --filter ScopeResolverTests 2>&1 | tail -15
```
...
```bash
cd /Users/lilei/wechatcli/WeChatHUD && swift test --filter ReviewTodoManagerTests 2>&1 | tail -15
...
```bash
cd /Users/lilei/wechatcli/WeChatHUD && swift test --filter UndoStoreTests 2>&1 | tail -15
...
```bash
cd /Users/lilei/wechatcli/WeChatHUD && swift test --filter DataLedgerTests 2>&1 | tail -15
...
```bash
cd /Users/lilei/wechatcli/WeChatHUD && swift test --filter GroupScreenerTests 2>&1 | tail -15
...
```bash
cd /Users/lilei/wechatcli/WeChatHUD && swift test --filter RetrospectiveAnalyzerTests 2>&1 | tail -15
...
```bash
cd /Users/lilei/wechatcli/WeChatHUD && swift test --filter RedBannerDetectorTests 2>&1 | tail -15
...
```bash
cd /Users/lilei/wechatcli/WeChatHUD && swift test --filter RetrospectiveJobTests 2>&1 | tail -20
...
```bash
cd /Users/lilei/wechatcli/WeChatHUD && make app && make run
```
...
```bash
grep -rn "ReportMode.weekly\|reportMode == .weekly" /Users/lilei/wechatcli/WeChatHUD/Sources /Users/lilei/wechatcli/WeChatHUD/Tests
```
...
```bash
cd /Users/lilei/wechatcli/WeChatHUD && swift build && swift test 2>&1 | tail -10
```
...
grep -rn "retrospectiveJob\|ChatMonitorScopeProvider\|ChatMonitorMessageQuery" \
  /Users/lilei/wechatcli/WeChatHUD/Sources \
  /Users/lilei/wechatcli/WeChatHUD/Tests \
  | grep -v "// " | head -30
```
...
```bash
cd /Users/lilei/wechatcli/WeChatHUD && swift package clean && swift build 2>&1 | grep "error:" | head -10
```
